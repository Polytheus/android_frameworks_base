...
#define REG_EJNI(demangled, name) { #name }
struct RegEJNIRec {
    const char* mName;
};
...
static const RegJNIRec gRegJNI[] = {
    ...
    REG_JNI(register_android_text_AndroidCharacter), //new
    ...
    REG_IJNI(register_android_util_FloatMath, _Z31register_android_util_FloatMathP7_JNIEnv),
    REG_IJNI(register_android_os_Debug, _ZN7android25register_android_os_DebugEP7_JNIEnv),
    REG_IJNI(register_android_os_Power, _ZN7android25register_android_os_PowerEP7_JNIEnv),
    REG_IJNI(register_android_util_Log, _ZN7android25register_android_util_LogEP7_JNIEnv),
    REG_IJNI(register_android_os_StatFs, _ZN7android26register_android_os_StatFsEP7_JNIEnv),
    REG_IJNI(register_android_os_Hardware, _ZN7android28register_android_os_HardwareEP7_JNIEnv),
    REG_IJNI(register_android_util_Base64, _ZN7android28register_android_util_Base64EP7_JNIEnv),
    REG_IJNI(register_android_os_FileUtils, _ZN7android29register_android_os_FileUtilsEP7_JNIEnv),
    REG_IJNI(register_android_debug_JNITest, _ZN7android30register_android_debug_JNITestEP7_JNIEnv),
    REG_IJNI(register_android_util_EventLog, _ZN7android30register_android_util_EventLogEP7_JNIEnv),
    REG_IJNI(register_android_os_SystemClock, _ZN7android31register_android_os_SystemClockEP7_JNIEnv),
    REG_IJNI(register_android_os_FileObserver, _ZN7android32register_android_os_FileObserverEP7_JNIEnv),
    REG_IJNI(register_android_content_XmlBlock, _ZN7android33register_android_content_XmlBlockEP7_JNIEnv),
    REG_IJNI(register_android_text_format_Time, _ZN7android33register_android_text_format_TimeEP7_JNIEnv),
    REG_IJNI(register_android_os_UEventObserver, _ZN7android34register_android_os_UEventObserverEP7_JNIEnv),
    REG_IJNI(register_android_emoji_EmojiFactory, _ZN7android35register_android_emoji_EmojiFactoryEP7_JNIEnv),
    REG_IJNI(register_android_content_StringBlock, _ZN7android36register_android_content_StringBlockEP7_JNIEnv),
    REG_IJNI(register_android_net_LocalSocketImpl, _ZN7android36register_android_net_LocalSocketImplEP7_JNIEnv),
    REG_IJNI(register_android_pim_EventRecurrence, _ZN7android36register_android_pim_EventRecurrenceEP7_JNIEnv),
    REG_IJNI(register_android_text_KeyCharacterMap, _ZN7android37register_android_text_KeyCharacterMapEP7_JNIEnv),
    REG_IJNI(register_android_backup_BackupDataOutput, _ZN7android40register_android_backup_BackupDataOutputEP7_JNIEnv),
    REG_IJNI(register_android_ddm_DdmHandleNativeHeap, _ZN7android40register_android_ddm_DdmHandleNativeHeapEP7_JNIEnv),
    REG_IJNI(register_android_os_ParcelFileDescriptor, _ZN7android40register_android_os_ParcelFileDescriptorEP7_JNIEnv),
    REG_IJNI(register_android_security_Md5MessageDigest, _ZN7android42register_android_security_Md5MessageDigestEP7_JNIEnv),
...
static const RegEJNIRec gRegExternalJNI[] = {
    ...
    //REG_EJNI(register_com_broadcom_bt_service_pbap_PBAPService, _Z49register_com_broadcom_bt_service_pbap_PBAPServiceP7_JNIEnv),
    //REG_EJNI(register_com_broadcom_bt_service_test_TestModeService, _Z53register_com_broadcom_bt_service_test_TestModeServiceP7_JNIEnv),
    //REG_EJNI(register_com_broadcom_bt_service_dun_BluetoothDUNService, _Z56register_com_broadcom_bt_service_dun_BluetoothDUNServiceP7_JNIEnv),
    //REG_EJNI(register_com_broadcom_bt_service_dg_BluetoothDataGatewayService, _Z63register_com_broadcom_bt_service_dg_BluetoothDataGatewayServiceP7_JNIEnv),
    //REG_EJNI(register_com_lge_system, _ZN7android23register_com_lge_systemEP7_JNIEnv), //what does this do?
    //REG_EJNI(register_android_lge_lgdrm, _ZN7android26register_android_lge_lgdrmEP7_JNIEnv), //DRM..
    REG_EJNI(register_android_net_wifi_WifiManager, _ZN7android37register_android_net_wifi_WifiManagerEP7_JNIEnv), /* heavy changes by LG */
    REG_EJNI(register_android_location_GpsLocationProvider, _ZN7android45register_android_location_GpsLocationProviderEP7_JNIEnv), /* needed ? */
    ...
    //REG_EJNI(register_android_net_wifiHiddenMenu_WifiHiddenMenuNative, _ZN7android56register_android_net_wifiHiddenMenu_WifiHiddenMenuNativeEP7_JNIEnv),
    //REG_EJNI(register_com_broadcom_bt_service_bpp_BluetoothPrinterService, _ZN7android60register_com_broadcom_bt_service_bpp_BluetoothPrinterServiceEP7_JNIEnv),
    //REG_EJNI(register_com_broadcom_bt_service_bpp_BluetoothPrinterEventLoop, _ZN7android62register_com_broadcom_bt_service_bpp_BluetoothPrinterEventLoopEP7_JNIEnv)
    
    /* bluetooth - common with eclair */ 
    ...
    //REG_EJNI(register_android_bluetooth_RfcommSocket, _ZN7android39register_android_bluetooth_RfcommSocketEP7_JNIEnv),
...
extern "C" {
    ...
    /* liblgerft functions */
    STUB(LGE_RFT_Channel)
    STUB(LGE_RFT_CloseDUT)
    STUB(LGE_RFT_FRError)
    STUB(LGE_RFT_FRGood)
    STUB(LGE_RFT_IsRunning)
    STUB(LGE_RFT_OpenDUT)
    STUB(LGE_RFT_RSSI)
    STUB(LGE_RFT_RxStart)
    STUB(LGE_RFT_RxStop)
    STUB(LGE_RFT_SetPreamble)
    STUB(LGE_RFT_TxBurstFrames)
    STUB(LGE_RFT_TxBurstInterval)
    STUB(LGE_RFT_TxDataRate)
    STUB(LGE_RFT_TxDestAddress)
    STUB(LGE_RFT_TxGain)
    STUB(LGE_RFT_TxPayloadLength)
    STUB(LGE_RFT_TxStart)
    STUB(LGE_RFT_TxStop)

    /* liblgdrm functions */
    STUB(_Z11JNU_InitIDsP7_JNIEnv)
    STUB(_Z14DrmStream_ReadP7_JNIEnvP8_jobjectiP11_jbyteArrayii)
    STUB(_Z14DrmStream_SkipP7_JNIEnvP8_jobjectix)
    STUB(_Z15DrmStream_CloseP7_JNIEnvP8_jobjecti)
    STUB(_Z16DrmManager_IsDRMP7_JNIEnvP7_jclassP8_jstring)
    STUB(_Z19DrmStream_AvailableP7_JNIEnvP8_jobjecti)
    STUB(_Z20DrmManager_initAgentv)
    STUB(_Z20DrmRight_GetKeyByCIDP7_JNIEnvP7_jclassP8_jstringP11_jbyteArrayS6_)
    STUB(_Z21DrmManager_AuthCallerP7_JNIEnvP7_jclass)
    STUB(_Z21DrmRight_GetRightInfoP7_JNIEnvP8_jobjectP8_jstringiii)
    STUB(_Z22DrmContent_ContentTypeP7_JNIEnvP7_jclassP8_jstringii)
    STUB(_Z22DrmContent_GetMetaDataP7_JNIEnvP8_jobjectS2_P8_jstringii)
    STUB(_Z22DrmRight_CheckMeteringP7_JNIEnvP8_jobjectP8_jstring)
    STUB(_Z23DrmRight_ManageMeteringP7_JNIEnvP8_jobjectP8_jstringh)
    STUB(_Z24DrmContentSession_DoRoapP7_JNIEnvP8_jobjectiP8_jstringiS4_)
    STUB(_Z24DrmRight_SetRandomSampleP7_JNIEnvP7_jclass)
    STUB(_Z25DrmContentSession_DrmOpenP7_JNIEnvP8_jobjectP8_jstringiiP11_jbyteArray)
    STUB(_Z25DrmContent_GetContentInfoP7_JNIEnvP7_jclassiP8_jstringii)
    STUB(_Z25DrmContent_GetContentSizeP7_JNIEnvP8_jobjectP8_jstringii)
    STUB(_Z25DrmManager_ManageDatabaseP7_JNIEnvP7_jclassi)
    STUB(_Z26DrmManager_SetDebugOptionsP7_JNIEnvP7_jclassiii)
    STUB(_Z27DrmManager_GetObjectDrmTypeP7_JNIEnvP7_jclassP11_jbyteArray)
    STUB(_Z27DrmObjectSession_ProcessEndP7_JNIEnvP8_jobjectiiiP8_jstring)
    STUB(_Z28DrmContentSession_GetDrmTimeP7_JNIEnvP8_jobject)
    STUB(_Z28DrmContentSession_JudgeRightP7_JNIEnvP8_jobjectP8_jstringiii)
    STUB(_Z28DrmManager_GetSupportedAgentP7_JNIEnvP7_jclass)
    STUB(_Z28DrmManager_ManageCertificateP7_JNIEnvP7_jclassi)
    STUB(_Z28DrmObjectSession_ProcessInitP7_JNIEnvP8_jobjectiP8_jstringS4_ii)
    STUB(_Z28DrmRight_GetRegistrationCodeP7_JNIEnvP7_jclass)
    STUB(_Z30DrmContentManager_DeleteRightsP7_JNIEnvP8_jobjectP8_jstring)
    STUB(_Z30DrmContentSession_ConsumeRightP7_JNIEnvP8_jobjectP8_jstringiiixx)
    STUB(_Z30DrmContentSession_GetRightInfoP7_JNIEnvP8_jobjectS2_P8_jstringiii)
    STUB(_Z30DrmContent_CheckPreviewContentP7_JNIEnvP8_jobjectP8_jstringi)
    STUB(_Z30DrmManager_GetContentBasicInfoP7_JNIEnvP7_jclassP8_jobjectP8_jstringi)
    STUB(_Z30DrmObjectSession_ProcessStatusP7_JNIEnvP8_jobjecti)
    STUB(_Z30DrmObjectSession_ProcessUpdateP7_JNIEnvP8_jobjectiP11_jbyteArrayii)
    STUB(_Z31DrmContentSession_GetIndexByCIDP7_JNIEnvP8_jobjectP8_jstringS4_)
    STUB(_Z31DrmObjectSession_DestroySessionP7_JNIEnvP8_jobjectii)
    STUB(_Z31DrmObjectSession_SetContentSizeP7_JNIEnvP8_jobjectix)
    STUB(_Z32DrmContentSession_GetContentListP7_JNIEnvP8_jobjectP8_jstring)
    STUB(_Z33DrmContentSession_ActivateContentP7_JNIEnvP8_jobjectP8_jstringiS4_)
    STUB(_Z33DrmManager_GetObjectMediaMimeTypeP7_JNIEnvP7_jclassP11_jbyteArray)
    STUB(_Z35DrmContentSession_GetDecryptionInfoP7_JNIEnvP8_jobjectiP8_jstringii)
    STUB(_Z36DrmManager_GetCertificateInformationP7_JNIEnvP7_jclassi)
    STUB(_Z37DrmContentSession_GetContentBasicInfoP7_JNIEnvP7_jclassP8_jobjectP8_jstringi)
    STUB(_Z37DrmContentSession_IsSettingsAvailableP7_JNIEnvP8_jobjectP8_jstringii)
    STUB(_Z45DrmContentManager_PreprocessDistributeContentP7_JNIEnvP8_jobjectP8_jstring)
    STUB(_Z47DrmContentManager_PostprocessDistributedContentP7_JNIEnvP8_jobjectP8_jstring)

    /* libbluedroid functions */
    STUB(fm_disable)
    STUB(fm_enable)
    STUB(bluetooth_enter_dut_mode)
    STUB(bluetooth_exit_dut_mode)
#endif
}
...
/*static*/ int AndroidRuntime::startReg(JNIEnv* env)
{
    ...
    void* dl = dlopen("libandroid_runtime_donut.so", RTLD_NOW | RTLD_LOCAL);
    if( !dl ) {
        LOGE("Error dlopen for libandroid_runtime_donut.so: %s\n", dlerror());
        env->PopLocalFrame(NULL);
        return -1;
    }
    for (size_t i = 0; i < NELEM(gRegExternalJNI); i++) {
        JniRegFunc func = (JniRegFunc) dlsym(dl,gRegExternalJNI[i].mName);
        if(!func) {
            LOGE("dlsym(): failed to find symbol %s\n", gRegExternalJNI[i].mName);
            env->PopLocalFrame(NULL);
            return -1;
        }
        LOGE("func %s is %x\n",gRegExternalJNI[i].mName, func);
        if(func(env) < 0) {
            LOGE("----------!!! %s failed to register\n", gRegExternalJNI[i].mName);
            env->PopLocalFrame(NULL);
            return -1;
        }
    }
