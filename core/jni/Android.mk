...
#The lib below is only build, so the other libraries can link against it during building them
#On the phone, the libandroid_runtime_eclair is used and called libandroid_runtime there
include $(CLEAR_VARS)
